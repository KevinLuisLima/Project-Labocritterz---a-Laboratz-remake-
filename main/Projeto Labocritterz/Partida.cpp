...
int fPartida(void){
    ...
    int TestesDoTabuleiro[9][4],X = 0,Y = 0,TravaCarta[12], CartasDoJogador1[12],CartasDoJogador2[12],NumerosDasCartas[12][4],CasaCheia[9],CartasNoTabuleiro[9], Contador;
    bool Colisao = false, Fechar = false;
    ...
    while(Fechar == false)
    {
        ...
        //Conta quantas cartas foram jogadas//
        if(RealizarVirada == 1){
            Contador += 1;
        }
        if(Contador == 9){
        ...
        //Fecha o jogo se a tecla esc for apertada//
        if(WindowShouldClose() == true){
            Fechar = true;
        }

        //Realiza os testes das cartas para virar elas//
        if(RealizarVirada == 1){
        ...
        if(Y == 0){
            ...
            if(Placar[0] == 0){
                DrawText("0",435,54,100,RED);
            }
            if(Placar[0] == 1){
                DrawText("1",435,54,100,RED);
            }
            if(Placar[0] == 2){
                DrawText("2",435,54,100,RED);
            }
            if(Placar[0] == 3){
                DrawText("3",435,54,100,RED);
            }
            if(Placar[0] == 4){
                DrawText("4",435,54,100,RED);
            }
            if(Placar[0] == 5){
                DrawText("5",435,54,100,RED);
            }
            if(Placar[0] == 6){
                DrawText("6",435,54,100,YELLOW);
            }
            if(Placar[0] == 7){
                DrawText("7",435,54,100,GREEN);
            }
            if(Placar[0] == 8){
                DrawText("8",435,54,100,GREEN);
            }
            if(Placar[0] == 9){
                DrawText("9",435,54,100,GREEN);
            }
            if(Placar[0] == 10){
                DrawText("10",435,54,100,GREEN);
            }

            if(Placar[1] == 0){
                DrawText("0",802,54,100,RED);
            }
            if(Placar[1] == 1){
                DrawText("1",802,54,100,RED);
            }
            if(Placar[1] == 2){
                DrawText("2",802,54,100,RED);
            }
            if(Placar[1] == 3){
                DrawText("3",802,54,100,RED);
            }
            if(Placar[1] == 4){
                DrawText("4",802,54,100,RED);
            }
            if(Placar[1] == 5){
                DrawText("5",802,54,100,RED);
            }
            if(Placar[1] == 6){
                DrawText("6",802,54,100,YELLOW);
            }
            if(Placar[1] == 7){
                DrawText("7",802,54,100,GREEN);
            }
            if(Placar[1] == 8){
                DrawText("8",802,54,100,GREEN);
            }
            if(Placar[1] == 9){
                DrawText("9",802,54,100,GREEN);
            }
            if(Placar[1] == 10){
                DrawText("10",802,54,100,GREEN);
            }
        }
    ...
    //Se a partida foi completa, armazena o placar//
    if(Contador == 9){
        FILE *pontArquivo = fopen("Resultados","a+");
        if (pontArquivo != NULL) {
		    ...
		    fprintf(pontArquivo, "%d;%d", Auxiliar1,Auxiliar2);
            fprintf(pontArquivo, "\n");
		    fclose(pontArquivo);
	    }else {
		puts("Nao foi possível criar arquivo");
	    }
    }
    return 0;
}
